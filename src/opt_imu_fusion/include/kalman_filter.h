...
public:
    ...
    KalmanFilter_1() {
        ...
        B = Eigen::MatrixXf::Zero(2, 1);
        C = Eigen::MatrixXf::Zero(2, 2);
        Q = Eigen::Matrix2f::Zero(2, 2);
        R = Eigen::MatrixXf::Zero(2, 2);
        u = Eigen::MatrixXf::Zero(1, 1);
        z = Eigen::MatrixXf::Zero(2, 1);
        I = Eigen::Matrix2f::Identity(2, 2);
        X = Eigen::MatrixXf::Zero(2, 1);
        P = Eigen::Matrix2f::Zero(2, 2);
        X_ = Eigen::MatrixXf::Zero(2, 1);
        P_ = Eigen::Matrix2f::Zero(2, 2);
        K = Eigen::MatrixXf::Zero(2, 2);
    }
